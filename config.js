...
module.exports = {
    ...
    SESSION: process.env.IMASH_CODE === undefined ? '' : process.env.IMASH_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.hizliresim.com/loUtAb.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'හරි බන් එලම♥' : process.env.ALIVE_BUTTON,
    ALIVEBTN2: process.env.ALIVE_BUTTON2 === undefined ? 'බොටා පට්ට♥' : process.env.ALIVE_BUTTON2,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? '⁨ɪͥᴛͭsᷤ ᴍᷟᴇͤ ī.am 𝜡𝛯ᗪ⁴⁰⁴⁩' : process.env.OWNER_NAME,
    BC: process.env.BROADCAST_NAME === undefined ? '⁨ɪͥᴛͭsᷤ ᴍᷟᴇͤ ī.am 𝜡𝛯ᗪ⁴⁰⁴⁩' : process.env.BROADCAST_NAME,
    PHONE: process.env.NUMBER === undefined ? '+94771323434' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'ɪᴍᴀꜱʜ ɴɪᴅᴜꜱʜᴀ' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴢᴇᴅ' : process.env.ALL_CAPTION,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ᴢᴇᴅ🍃' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'ᴢᴇᴅ🍃' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'ZED' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'ZED💞/💝/✨/📝' : process.env.CMD_LIST,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Note this' : process.env.TAG_HEADER,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '94771323434,0,94711117547,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
